        ...
        <div class="dashboard-cards  h-screen grid grid-col-1 pb-24">
            ...
            <div class="overflow-y-hidden grid grid-col-1">
                  <div class="overflow-x-hidden  grid md:grid-cols-2  pr-4 sm:px-4 pt-5"
                        ...
                        <div class="px-16 py-8  bg-gray-50 shadow-md rounded-md div-hover">
                            <img class="mx-auto" src="{{ asset('images/propo.png') }}" alt="" srcset="">
                            <p class="text-xl flex justify-center text-gray-600">Post Job</p>
                            <a href="{{ route('create-new-job') }}" class="flex justify-center text-md text-blue-500">Click to post</a>
                        </div>

                        <div class="px-16 py-8  bg-gray-50 shadow-md rounded-md div-hover">
                           <img class="mx-auto" src="{{ asset('images/propo.png') }}" alt="" srcset="">
                           <p class="text-xl flex justify-center">Jobs Posted</p>
                           <p class="flex justify-center"> ({{ auth()->user()->listings()->count() }}) </p>
                           <a href="#" class="flex justify-center text-md text-blue-500">Click to view</a>
                        </div>

                        <div class="px-8 py-8  bg-gray-50 shadow-md rounded-md div-hover">
                           <img class="mx-auto" src="{{ asset('images/new_msg.png') }}" alt="" srcset="">
                           <p class="text-xl flex justify-center">Incoming Applications</p>
                           <p class="flex justify-center">({{ request()->get('totalMessage') }})</p>
                           <a href="#" class="flex justify-center text-md text-blue-500">Click to view</a>
                        </div>

                       <div class="px-8 py-8  bg-gray-50 shadow-md rounded-md div-hover">
                         <img class="mx-auto" src="{{ asset('images/target.png') }}" alt="" srcset="">
                         <p class="text-xl flex justify-center">Acceptance Letter</p>
                         <p class="flex justify-center">(0)</p>
                         <a href="#" class="flex justify-center text-md text-blue-500">Click to view</a>
                       </div>
                        ...
                        <div class="px-16 py-8  bg-gray-50 shadow-md rounded-md div-hover invisible">
                            <img class="mx-auto" src="{{ asset('images/new_msg.png') }}" alt="" srcset="">
