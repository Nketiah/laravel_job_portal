...
@section('content')
     ...
     <div class="flex flex-col sm:flex-row  rounded-lg  mb-10">
        <div class="bg-gradient-to-r from-purple-500 to-blue-900  w-full pt-20 sm:w-6/12 pb-40 ">
         ...
         <div class="w-full sm:w-6/12 pt-28 pb-20 px-4 bg-white p-6 ">
            ...
            <div class="px-3 sm:px-32 mb-6  sm:mx-auto"> 
                 <div class="flex justify-items-center mb-2">
                      ...
                      <p class="pb-10 text-3xl mt-3 text-gray-500">Reset your password</p>
                 </div>
                 <form action="{{ route('password.request') }}" method="post">
                    ...
                    <div class="mt-10">
                        <button type="submit" class="bg-blue-500 text-white px-4 py-4 rounded 
                         w-full text-lg font-bold hover:bg-blue-600">Reset your password</button>
                    </div>

                    @if (session('status'))
                        <div class="px-24 py-3 rounded mt-40 bg-green-800 text-gray-100 mb-6 font-bold">
                        <p class="text-lg">{{ session('status')}}</p>
                        </div>
                   @endif
                </form>
            </div>
