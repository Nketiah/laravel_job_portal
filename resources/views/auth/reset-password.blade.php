...
@section('content')
     ...
     <div class="flex flex-col sm:flex-row  rounded-lg  mb-10">
        <div class="bg-gradient-to-r from-purple-500 to-blue-900  w-full pt-20 sm:w-6/12 pb-40 ">
         ...
         <div class="w-full sm:w-6/12 pt-20 pb-20 px-4 bg-white p-6 ">
            ...
            <div class="px-3 sm:px-32 mb-6  sm:mx-auto"> 
                 <div class="flex justify-items-center mb-2">
                      ...
                      <p class="pb-10 text-3xl mt-3 text-gray-500">Update Your Password</p>
                 </div>
                 <form action="{{ route('password.update') }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email') border-red-500 @enderror" value="{{ $request->email }}">
                        @error('email')
                    ...
                    <div>
                        <button type="submit" class="bg-blue-500 text-white px-4 py-4 mt-5 rounded 
                        font-medium w-full text-lg">Update Password</button>
                    </div>
                </form>
            </div>
